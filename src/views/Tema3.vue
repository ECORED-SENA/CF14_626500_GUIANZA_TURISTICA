  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-8
        ...
        p.mb-4 La Accesibilidad y el Diseño Universal (A.D.U) es el arte de crear y adaptar los entornos, servicios y productos a las personas, para que sean utilizables por todos de la forma más autónoma y natural posible (MINCIT, 2019, p.28).
        p.mb-0 Contexto Internacional:  es indudable que las regiones del mundo más sólidas desde el punto de vista económico y socialmente evolucionadas, han descubierto desde hace tiempo la necesidad y conveniencia de desarrollar políticas de turismo accesible.  En el caso europeo se han establecido importantes políticas de incentivo y estímulo a la inversión privada para el desarrollo del turismo accesible.
      ...
      .col-lg-12
        .tarjeta.colorblanca.p-4
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Aquellas personas con movilidad reducida y que presentan dificultad para desplazarse.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Usuarios de silla de ruedas, caminadores, muletas, bastones y personas que requieran otro tipo de ayuda para su movilización.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Aquellas personas que presentan una enfermedad permanente, temporal o parcial.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Personas vulnerables en su movilización.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/6.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 (Ceguera, baja visión, daltonismo).
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Aquellas personas que presentan dificultad en la visión y percepción de los espacios.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Aquellas personas que presentan una enfermedad permanente, temporal o parcial.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Aquellas personas que se movilizan autónomamente con elementos podotáctiles, aplicaciones tecnológicas o animales guías.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/7.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Tienen poca o nula comunicación oral y auditiva. Para comunicarse utilizan la lengua de señas y en algunas ocasiones hacen lectura de labios.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Las personas con discapacidad auditiva sordas pueden presentar esta condición desde antes de nacer o puede que se presente después de haber aprendido alguna lengua oral (hipoacusia). 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Existen diferentes niveles de sordera (baja, severa y profunda). Cuando la condición de sordera es baja, se le conoce con el nombre de hipoacusia. 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En los países de habla hispana, pueden variar algunas de las señas. La lengua de señas no es universal. 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Algunas personas que presentan hipoacusia presentan también dificultad para leer textos escritos.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/8.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que presentan pérdida severa de la audición y de la visión.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Según lo manifiesta la OMS (Organización Mundial de la Salud) es una discapacidad múltiple y su origen puede ser congénito. 
                    li
                      i.fas.fa-paper-plane 
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que tienen deficiencias en su inteligencia por debajo del promedio.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan dificultades para analizar, comprender y desarrollar algunas destrezas.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas requieren educación especializada y dependiendo del caso también van a necesitar compañía de otra persona; de acuerdo con el nivel intelectual, pueden llegar a ser personas totalmente autónomas. 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas muestran estas condiciones desde temprana edad, aunque se puede presentar posteriormente a causa de enfermedades o accidentes presentados en la vida.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/10.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que presentan enfermedades mentales que no fueron tratadas.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos, las condiciones particulares y actitudes que tienen estas personas generan barreras que impiden un adecuado desarrollo social.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas pueden presentar discapacidad parcial o permanente y estos síntomas no tienen ninguna relación con sus capacidades intelectuales.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas pueden presentar miedo, angustia, ser retraídos, entre otros signos de alerta. Cuando las condiciones son muy severas, es indispensable que tengan un acompañante.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/11.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan más de una discapacidad.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Por lo general estas personas requieren de un acompañante o cuidador, dependiendo de su capacidad de movilización y desarrollo personal.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas pueden ser usuarias de perros guías.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas usan productos de apoyo, como lo pueden ser las sillas de ruedas, los caminadores bastones o muletas.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas en algunos casos requieren de asistencia médica frecuentemente.
                    li
                      i.fas.fa-paper-plane 
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que presentan una estatura inferior al promedio de acuerdo a su edad.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan una disminución en su movilidad y presentan dificultad para desarrollar algunas actividades.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan disminución en su capacidad de alcance y movilidad de objetos.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas usan productos de apoyo los cuales pueden ser sillas de ruedas, caminadores, bastones y algunas otras ayudas de tipo ortopédico. 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan en algunos casos disminución en su capacidad motriz y física.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos, estas personas presentan un crecimiento inarmónico en el cuerpo.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/13.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que de acuerdo a su edad tienen una estatura superior al promedio.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas tienen un crecimiento más veloz que lo normal, esto por lo general se da desde su nacimiento hasta la primera infancia.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas presentan disminución en su capacidad de movilidad y en el desarrollo de algunas actividades.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas presentan un crecimiento del cuerpo de manera disarmoníca.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas pueden ser usuarias de productos de apoyo, tales como sillas de ruedas, caminadores, bastones y otros tipos de ayudas ortopédicas.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas presentan un desarrollo desproporcionado de los pies, las manos y el mentón. 
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/14.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que tienen una dimensión corporal más grande que el promedio.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan una disminución en su capacidad física o motriz.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas tienen un peso corporal mayor al tamaño de sus huesos.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Generalmente estas personas tienen una disminución leve en su capacidad para movilizarse y desarrollar algunas actividades.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas tienen tendencia a ser obesos y pueden llegar a requerir mayor aporte de calorías.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas requieren usar productos de apoyo, tales como sillas de ruedas, bastones, muletas o caminadores.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/15.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que tienen alguna limitación temporal física o alguna enfermedad que no le permita realizar algún movimiento específico.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estos casos se trabajan con reserva médica guardando todos los cuidados necesarios, recuerde que la responsabilidad de la salud del paciente es del guía y de la persona.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Según la enfermedad se debe trabajar grupos pequeños o aislamientos especiales.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/16.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son personas que tienen una reducción de su movilidad y comunicación, claro está que esto depende de las condiciones y características específicas de cada persona.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas tienen una tendencia a sufrir alguna enfermedad parcial o permanente. 
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas con el paso del tiempo pueden llegar a adquirir alguna discapacidad.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 En algunos casos estas personas requieren el apoyo de un acompañante.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas presentan tendencia a sufrir de enfermedades de tipo senil y algunas condiciones específicas de tipo mental, física o cognitiva.
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/17.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Son aquellas personas que por su corta edad pueden variar su capacidad de movilidad y desplazamiento.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas requieren de acompañamiento.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas se encuentran en etapa de crecimiento.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas requieren entornos que le brinden protección y seguridad.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Por lo general estas personas tienen períodos muy cortos de atención. 
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/18.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
          ...
          .row.align-items-center.mb-4
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas son protectoras de una vida adicional que se encuentra dentro de su cuerpo. Estos seres humanos se encuentran en crecimiento constante dentro del vientre de la madre y presentan necesidades propias de su proceso de desarrollo.
                    li
                      i.fas.fa-paper-plane 
            ...
            .col-lg-4
              figure
                img(src='@/assets/curso/tema3/19.jpg', alt='Texto que describa la imagen') 
          .row.justify-content-center
            .col-md-12
              hr.lineagris
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas transportan cargas adicionales, lo cual afecta su movilidad y desplazamiento.
                    li
                      i.fas.fa-paper-plane 
              ...
              .row 
                .col-lg-12
                  ul.lista-ul--color.mb-0
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas viajan a un lugar con la mentalidad de vivir experiencias únicas y diferentes.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas no poseen el conocimiento de la lengua de determinado país que visitan.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas no conocen las condiciones socioculturales y así mismo las características del territorio visitado.
                    li
                      i.fas.fa-paper-plane 
                      p.mb-0 Estas personas necesitan ayudas específicas y el apoyo del personal asociado a las actividades turísticas que realizará en el lugar de viaje y estadía.
            .col-lg-4
              figure
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-7
        ...
        ul.lista-ul--color.mb-0
          li
            i.fas.fa-paper-plane 
            p.mb-0 La persona en situación de discapacidad no siempre tiene retardo.
          li
            i.fas.fa-paper-plane 
            p.mb-0 La persona en situación de discapacidad no siempre es inmadura.
          li
            i.fas.fa-paper-plane 
            p.mb-0 La discapacidad no la hace necesariamente más frágil.
          li
            i.fas.fa-paper-plane 
            p.mb-0 La persona en situación de discapacidad no necesita compasión.
          li
            i.fas.fa-paper-plane 
    ...
    .row.align-items-center.mb-4
      .col-lg-8
        .slyderB_bg_02.py-4.px-4
          SlyderA
            .row.align-items-center.justify-content-center.p-5
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 Respetaré a las personas con discapacidad.
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 Trataré como iguales a las personas con discapacidad en los distintos ambientes (escuela, trabajo, calle, etc.).
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 Tomaré conciencia, que la discapacidad es solo una condición más del ser humano, como ser alto, bajo, gordo, flaco, negro, blanco, indio o mestizo.
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
              ...
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 No invadiré los espacios reservados para personas con discapacidad en lugares públicos.
            ...
            .row.align-items-center.justify-content-center.p-5
              ...
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 Utilizaré el término personas con discapacidad para referirme a ellos.
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 Canalizaré a las personas con discapacidad a entidades que les permitan un desarrollo para mejorar su calidad de vida.
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
                p.mb-2 No ocasionaré conflictos ni enfrentamientos directos con personas que no tienen esta cultura de respeto y trato digno de las personas con discapacidad.
              .col-lg-1
                figure.mb-2
                  img(src='@/assets/curso/tema3/vec1.svg', alt='Texto que describa la imagen')
              .col-lg-11
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-8
        ...
        ul.lista-ul--color.mb-0
          li
            i.fas.fa-paper-plane 
            p.mb-0 Personas en sillas de ruedas o con movilidad reducida.
          li
            i.fas.fa-paper-plane 
            p.mb-0 Personas en situación de discapacidad auditiva.
          li
            i.fas.fa-paper-plane 
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-7
        AcordionA.mb-2(tipo="a" clase-tarjeta="tarjeta tarjeta-azul")
          ...
          .row(titulo="En la planeación del recorrido")
          ...
          .row(titulo="Preparar su indumentaria")
            p.mb-0 En el momento de la planeación del recorrido guiado, el guía de turismo debe identificar la cantidad de ayuda que necesitará para el desarrollo del servicio contratado, en algún caso se puede requerir de ayuda adicional, este personal también debe estar en la capacidad para atender al turista con seguridad y velar también por la seguridad de él mismo.  

          .row(titulo="En la comunicación")
            p.mb-0 El guía deberá identificar también si requiere de algún sistema o herramienta de comunicación alternativa para poder prestar un mejor servicio al turista con discapacidad.  Igual, tener claro el plan de acción a realizar en los recorridos orientados a personas en situación de discapacidad, previamente a la realización de cualquier recorrido turístico.

          .row(titulo="En el tiempo")
            p.mb-0 En la realización del recorrido guiado no se debe apurar o afanar al turista con discapacidad, a menos que por circunstancias específicas sea indispensable hacerlo; estos recorridos se realizan para disfrutarlos.  El guía debe ser paciente, algunos turistas que tienen alguna discapacidad puede hablar de manera lenta o con dificultad, se debe ser consciente que no todas las personas tienen las mismas capacidades o niveles cognitivos. Tener en cuenta que el guía debe repetir la información las veces que sea necesaria, hasta que sea entendida por la totalidad del grupo, sobre todo cuando se trata de dar instrucciones puntuales o información relevante. 
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-8
        ...
        ul.lista-ul--color.mb-0
          li
            i.fas.fa-paper-plane 
            p.mb-0 Es necesario advertir al turista cuando se acercan a un obstáculo, como por ejemplo una escalera. 
          li
            i.fas.fa-paper-plane 
            p.mb-0 En el momento que se estén acercando a un grupo de personas, el guía debe ampliar el paso.
          li
            i.fas.fa-paper-plane 
            p.mb-0 Para evitar algún obstáculo, el guía debe apretar el brazo contra él o alejar el brazo para esquivarlo, según sea la ubicación del elemento.
          li
            i.fas.fa-paper-plane 
            p.mb-0 En el momento de subir o bajar escaleras, el guía debe hacerlo de manera perpendicular, de esta manera el turista podrá intuir si se va a subir o bajar la escalera.
          li
            i.fas.fa-paper-plane 
        ...
        .slyderB_bg_01.px-5.py-3
          SlyderA(tipo="b")
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="01")
                  h4 Sistema de transporte accesible
                  p.mb-0 Debe tener mapas con las diferentes rutas que orienten e informen a los usuarios, estos también deben dar información auditiva; la señalización debe tener contrastes de colores, utilizar alto relieve, braille y lengua de seña. Los sistemas pueden ser visuales y sonoros.
              .col-8.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="02")
                  h4 Espacio público accesible
                  p.mb-0 Las franjas de circulación peatonal deben tener de ancho como mínimo 150 cm y no deben presentar ningún tipo de obstáculos; el piso debe ser firme, contar con señalización podotáctil.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="03")
                  h4 Hotel y alojamiento accesible
                  p.mb-0 En dado caso de requerir, el inmueble debe contar con una rampa de acceso que cumpla con los parámetros nacionales, como es su ancho de mínimo 100 cm y su pendiente máxima de 10%. El espacio de ingreso debe estar correctamente iluminado y señalizado.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="04")
                  h4 Restaurante, bar y discoteca accesible
                  p.mb-0 En lo posible deberá tener un parqueadero propio cercano a la entrada principal del inmueble; el acceso y los espacios de circulación interna y externa deberán tener un ancho mínimo de 150 cm, evitando tener barreras u obstáculos que impidan la libre circulación, las mesas deben estar a la altura de las sillas de ruedas.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="05")
                  h4 Parque urbano, temático y de diversiones accesible.
                  p.mb-0 Los espacios de circulación, el mobiliario, las instalaciones, los baños y demás elementos del parque deberán contar con los criterios básicos de accesibilidad. Los elementos de juego deberán garantizar que todas las personas que se encuentren en el rango de edad al que están dirigidos puedan acceder a ellos. 
              .col-8.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="06")
                  h4 Parque natural (ecoturismo) accesible
                  p.mb-0 El parqueadero debe ser en pavimento y antideslizante y señalizado con el símbolo internacional de accesibilidad. Si existen algunos desniveles en los espacios de circulación, se deberán adaptar con rampas. La señalización de los senderos deberá ser fabricada en materiales no contaminantes. 
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="07")
                  h4 Museo accesible
                  p.mb-0 El personal que trabaja en el museo y que atiende al público debe tener formación en la atención de diferentes grupos poblacionales; se deberán tener recorridos en lengua de señas, se deberá utilizar maquetas táctiles, folletos en braille, audioguías y demás elementos que puedan llegar a facilitar la realización de los recorridos en el museo, los carteles deben estar ajustados a ello también.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="08")
                  h4 Playa, piscina y zona húmeda accesible.
                  p.mb-0 El parqueadero debe ser accesible y quedar cercano a la playa. La playa y todos los equipamientos específicos y los servicios públicos deben tener paneles informativos y señalización para que de esta manera sea más sencillo que las personas identifiquen el entorno. La pendiente máxima de las rampas será del 10%.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="09")
                  h4 Espacio de información turística accesible
                  p.mb-0 La mesa de recepción debe tener condiciones de accesibilidad para que una persona en silla de ruedas se pueda acercar libremente, debe estar sin ningún tipo de obstáculo para permitir la maniobrabilidad de la silla. Debe contar con personal que pueda trasmitir información básica en lengua de señas.
              .col-4.col-lg-8
                figure
            ...
            .row.justify-content-center.align-items-center.my-lg-4
              .col-lg-4.mb-4.mb-lg-0.pt-5.pt-0.position-relative
                .number(data-number="10")
                  h4 Patrimonio histórico y cultural accesible
                  p.mb-0 Los visitantes que posean discapacidad visual o auditiva deberán tener espacios preferenciales reservados en las zonas ideales, estos lugares deben estar demarcados para facilitar su identificación. 
              .col-4.col-lg-8
                figure
